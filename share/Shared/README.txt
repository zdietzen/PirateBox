...
<footer id="about">
	<div class="container">
		<div id="details">
			...
			<p>You are connected to a "PirateBox". Inspired by pirate radio and the free culture movement, PirateBox is a self-contained mobile collaboration and file sharing device. PirateBox utilizes Free, Libre and Open Source software (FLOSS) to create mobile wireless file sharing networks where users can anonymously share images, video, audio, documents, and other digital content.</p>
			...
			<small>Built by: Dietzen Development www.zakdietzen.com</small>
		</div>
	</div>
</footer>