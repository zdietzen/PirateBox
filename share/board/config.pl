...
use constant SECRET => 'ZHUKSJVASLKDHUGABUDS34567ZZ';		# Cryptographic secret. CHANGE THIS to something totally random, and long.
...
# Page look
use constant TITLE => 'Origin Code Meetup Forum';	# Name of this image board
...
use constant TITLEIMG => 'logo_big';			# Title image (point to a script file if rotating)
